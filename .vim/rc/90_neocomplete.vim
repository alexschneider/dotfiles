...
inoremap <expr> <CR>  pumvisible() ? neocomplete#close_popup() : delimitMate#ExpandReturn()
" <TAB>: completion.
...
inoremap <expr><Space> pumvisible() ? neocomplete#cancel_popup() . delimitMate#ExpandSpace() : delimitMate#ExpandSpace()
